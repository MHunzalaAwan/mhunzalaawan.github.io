...
* **Networking and Security:** OpenVPN, DHCP, Linux HA Clusters, Security Policy Implementation
* **Database Platforms:** MySQL, PostgreSQL, MSSQL
* **IoT and Embedded Technologies:** Embedded Linux, NetBSD, IoT Platforms, Device Management
* **ERP and CRM Tools:** Dynamics 365
* **Data Analysis and Visualization:** ArcGIS, QGIS, ML/AI tools for data processing and anomaly detection
* **Project Management Methodologies:** Agile (Scrum, Kanban), Vendor Management, Resource Allocation, Scope & Schedule Management, Risk Management.
...
* Spearheaded the **development and successful deployment** of a comprehensive **IoT platform** for a major telecom client, enabling advanced remote site monitoring and control that resulted in a **20% decrease in downtime** and an **18% reduction in operational costs**.
...
* Directed and mentored **cross-functional teams** in the delivery of high-impact technology solutions, integrating **data analysis**, **business analysis**, and customer feedback into **agile project workflows** to ensure alignment with **strategic business needs** and **stakeholder expectations**.
...
* Oversaw and optimized **vendor relationships** to ensure **accountability, cost-effectiveness, and strategic alignment**, establishing reliable partnerships that supported company growth objectives and **lowered overhead costs by 12%**.
...
* Improved **security, scalability, and manageability** for **IoT systems** by implementing updated toolsets and leveraging **AWS cloud services**, resulting in a robust and scalable infrastructure foundation.
...
* Oversaw the deployment and support of custom **IoT solutions**, coordinating effectively across internal and external teams to ensure timely project delivery and maintain high system availability.
* Collaborated with **stakeholders** to define complex business and system requirements, ensuring alignment with organizational goals and securing buy-in for critical system improvements.
...
* Configured and deployed **Linux systems** for a critical Remote Monitoring System, improving operational control and reducing downtime for mission-critical applications by **15%**.
...
* Provided technical support across departments, facilitating quick troubleshooting and maintaining productivity.
